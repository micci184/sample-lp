...
const ServiceSection: React.FC = () => {
  return (
    <div className="px-4 sm:px-10 md:px-20 lg:px-40 pt-8 sm:pt-16 md:pt-24 lg:pt-32 pb-8 sm:pb-10 md:pb-10 lg:pb-10 min-h-[200px] md:min-h-[300px] lg:min-h-[400px]">
